...
async function fetchData() {
    ...
    document.getElementById('city').innerHTML = `${cityInfo.data[0].city}<br>${cityInfo.data[0].country} <br>Population: ${cityInfo.data[0].population}<br>Elevation: ${weatherInfo.elevation}m <br>${weatherCurrently}<br>Current Temperature: ${weatherInfo.current_weather.temperature}°C`
